...
void main() {
  runApp(MaterialApp(home: HotelDetialsPage()));
}

class HotelDetialsPage extends StatelessWidget {
  @override
    ...
    return Scaffold(
      body: Stack(
        children: <Widget>[
          Container(
            child: Image.network(
              'https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRlTTqxp8iFI_xVNvD3lDXZsxb3-05f3TJ47E9e9JfphQ&usqp=CAU&ec=48665701',
              fit:
              BoxFit.cover,),
